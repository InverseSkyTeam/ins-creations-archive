                ...
                if event.button == 1:
                    ...
                    while True:
                        ...
                        for event in pygame.event.get():
                            ...
                            if event.type == pygame.MOUSEBUTTONDOWN:
                                mPos = event.pos
                                if huarect.collidepoint(event.pos):
                                    state2 = 0
                            ...
                            if event.type == pygame.MOUSEBUTTONDOWN:
                                mPos = event.pos
                                if huarect2.collidepoint(event.pos):
                                    state3 = 0
                            if event.type == pygame.MOUSEBUTTONUP:
                                state3 = 1
                            if state3 == 0:
                                ...
                                if j!=i:
                                    if i.rect.colliderect(j.rect):
                                        if (i.plus_x >0 and j.plus_x <0) or (i.plus_x <0 and j.plus_x >0):
                                            ...
                                            i.plus_x = -i.plus_x
                        screen.blit(pygame.font.SysFont(FONTNAME,40).render("小球质量:",True,(255,255,255)),(490,670))
                        huarect = pygame.Rect(x,691,20,20)
                        draw_rect((660,700),x-660,4,0,(255,255,255))
                        pygame.draw.ellipse(screen,(255,255,255),huarect,0)
                        screen.blit(pygame.font.SysFont(FONTNAME,40).render("重力加速度:",True,(255,255,255)),(450,620))
                        huarect2 = pygame.Rect(x2,641,20,20)
                        draw_rect((660,650),x2-660,4,0,(255,255,255))
                        pygame.draw.ellipse(screen,(255,255,255),huarect2,0)
                        for i in ball_list:
                            i.m = x-660
                            i.g = x2-660
