                                    ...
                                    if event.type == pygame.MOUSEBUTTONDOWN:
                                        if event.button==1 and flag == 1:
                                            while True:
                                                                                                                    ...
                                                                                                                    if event.type == pygame.MOUSEBUTTONDOWN:
                                                                                                                        if event.button==1:
                                                                                                                            if img1.size[0]>1200 and img1.size[1]>650:
                                                                                                                                screen1 = screen
                                                                                                                            if img1.size[0]>1200:
                                                                                                                                screen1 = pygame.transform.chop(screen, (1200, img1.size[1]-lenth1,1200, 650))
                                                                                                                            if img1.size[1]>650:
                                                                                                                                screen1 = pygame.transform.chop(screen, (img1.size[0]-lenth1, 650,1200, 650))
                                                                                                                            else:
                                                                                                                                screen1 = pygame.transform.chop(screen, (img1.size[0]-lenth1, img1.size[1]-lenth1,1200, 650))
                                                ...
                                                pygame.draw.ellipse(screen,(255,255,255),c3,0)
