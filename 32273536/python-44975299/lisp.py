...
type>>>"""
        ...
        if c == "1":
            ...
            print("此版本测试升级，依赖pytest。请在本地python环境安装pytest后运行测试")            
        elif c == "3":
            print(
                f"""源码：{
                '''
            ...
            print(
"""
Runctional Documentation v0.0.1 Alpha

0. 这是什么？
    这是用python3.10+版本实现的简易lisp解释器，支持简易的repl，支持尾递归优化。
    不熟悉lisp语法的用户无法上手，故本项目参考意义远大于实用意义，尽管代码写的不算多好。
1. 文档在哪里？
    还在写。写好后会在单独的作品发布。可以在git仓库关注动态。
""")
        else:
            print("无效选择。")
