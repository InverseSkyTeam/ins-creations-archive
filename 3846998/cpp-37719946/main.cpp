...
struct Compiler{
    string code;
    int ifcode=0,whilecondcode=0,whileendcode=0,forcode=0;
    stack<4096> scope;
    ...
    void stmt(){
        ...
        /*else if(nextid()=="puts"){
            ...
            int _a=scope.pop();
            eat(";");
            write("FORCOND"+to_string(fc)+":");
            expr();
            eat(";");
            write("JNZ");
            write("FOREND"+to_string(fc));
            write("JMP");
            write("FORBEGIN"+to_string(fc));
            write("FORNEXT"+to_string(fc)+":");
            stmt();
            eat(")");
            eat("{");
            write("JMP");
...
"main:",
    ...
    code=Compiler("fun main(){for(int i;i<10;set i i+1){write i putchar(10)}}").compile();
