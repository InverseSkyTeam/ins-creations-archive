...
try:
    ...
    print('学而思用户您好，需要先下载三方库才能运行，请自行在右上角“库管理”搜索websocket-client库并下载，注意带-client')
    sys.exit()
# 专治联机游戏不爽
...
if platform.system() == 'Windows':
    ...
    print('学而思用户，请用windows系统观看，pygame中的部分内容不兼容非windows系统')
    sys.exit()
# 专治联机游戏不爽
...
def 食(name,content,userid,project_id=21170915):
    try:
...
def 拉(filename,userid,to_get='file',project_id=21170915):
    message = {
        "method": "handshake",
        "user": str(userid),
