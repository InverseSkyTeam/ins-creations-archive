from codeBreaker.Breaker import (作品访问器,作品访问器2,作品访问器4)
...
def show_data(title,url):
    ...
    t10 = '评论数：'+str(作品访问器.评论数(url))
    t11 = '热度：'+str(round(作品访问器4.热度(url),4))
    t12 = '手动变量值：'+str(作品访问器4.手动变量(url))
    ut1 = '输出源码'
    ut2 = '输出作品说明'
    ut3 = '作者主页'
    ut4 = '作者头像源'
    ...
    def ud1():
        print(作品访问器.源码(url)+'\n\n\n')
    def ud2():
        print(作品访问器.作品说明(url)+'\n\n\n')
    def ud3():
        print(作品访问器.作者主页(url)+'\n\n\n')
    def ud4():
        print(作品访问器.作者头像源(url)+'\n\n\n')
    def ud5():
        print(作品访问器2.代码多少(url)+'\n\n\n')
    def ud6():
        作品访问器.api(url)
    ...
    b9.pack()
    b10 = tk.Label(root,text=t10)
    b10.pack()
    b11 = tk.Label(root,text=t11)
    b11.pack()
    b12 = tk.Label(root,text=t12)
    b12.pack()
    ...
    u5.pack()
    u6 = tk.Button(root,text=ut6,command=ud6)
    u6.pack()
    root.mainloop()