...
while True:
    while part == 'mainpage':
        ...
        show_text('V0.3.0',(111,111,111),(800,11),60)
        ...
        show_text('(c)Copyright.INS-jhx逆天团队小轩 /did with python on 2022.6.5 /(v)Version->0.3.0 -α',(111,111,111),(11,90),11)
        if lmbcmpos == True:
    ...
    while part == 'start view ijca':
        ...
        show_text(str(round(clock.get_fps(),1))+'/FPS',(0,0,0),(811,11),40)
        show_text('按N下一帧',(0,0,0),(811,51),40)
        pygame.display.update()
        clock.tick()