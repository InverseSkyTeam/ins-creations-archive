...
cube = [Cube(Point(300,200,200),[Point(-50,-50,50),Point(50,-50,50),Point(-50,50,50),Point(50,50,50),Point(-50,-50,-50),Point(50,-50,-50),Point(-50,50,-50),Point(50,50,-50)]) for i in range(100)]
...
while True:
    ...
    for c in cube:
        c.draw(screen)
        c.rotatex(r(-5,5)/100+cube.index(c)/1000)
        c.rotatey(r(-5,5)/100+cube.index(c)/1000)
        c.rotatez(r(-5,5)/100+cube.index(c)/1000)
    pygame.draw.circle(screen,(255,0,0),Point(300,200,200).perspective(),3)
    pygame.display.update()
    cc.tick()
    if r(1,10) == 1:
        print('fps:',cc.get_fps())