...
view_speed_button = pygame.Rect((811,61,20,20))
lmbcmpos = False
lvbcmpos = False
do_file_name_x = None
choose_color = (0,0,0)
...
while True:
    while part == 'mainpage':
        ...
        show_text('V0.4.9',(111,111,111),(800,11),60)
        ...
        show_text('(c)Copyright.INS-jhx逆天团队小轩 /did with python on 2022.6.11/(v)Version->0.4.9 -P',(111,111,111),(11,90),11)
        if lmbcmpos == True:
    ...
    while part == 'start view ijca':
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEMOTION:
                if mouseleftbutton_isdown == True:
                    view_speed_button.y = event.pos[1] - 10
                    if view_speed_button.y < 61:
                        view_speed_button.y = 61
                    if view_speed_button.y > 231:
                        view_speed_button.y = 231
                    if view_speed_button.y < 65:
                        view_speed = 'stop'
                    else:
                        # view_speed = round(1/((view_speed_button.y-61)/17),3)
                        view_speed = round(17/(view_speed_button.y-61),3)
            if event.type == pygame.MOUSEBUTTONDOWN:
                if view_speed_button.collidepoint(event.pos):
        ...
        show_text('播放台',(0,0,0),(811,11),40)
        pygame.draw.line(screen,(255,0,0),(821,71),(821,91),3)
        pygame.draw.line(screen,(0,0,0),(821,91),(821,201),3)
        pygame.draw.line(screen,(0,0,255),(821,201),(821,241),3)
        if view_speed_button.y < 81:
            pygame.draw.rect(screen,(238,0,0),view_speed_button,0)
        elif view_speed_button.y < 191:
            pygame.draw.rect(screen,(238,238,238),view_speed_button,0)
        else:
            pygame.draw.rect(screen,(0,0,238),view_speed_button,0)
        pygame.draw.rect(screen,(0,0,0),view_speed_button,2)
        show_text('--',(0,0,0),view_speed_button,20)
        show_text('手动',(255,0,0),(831,61),20)
        show_text('自动',(0,0,255),(831,231),20)
        show_text('按N下一帧',(0,0,0),(811,261),40)
        show_text('播放速度：',(0,0,0),(811,301),40)
        if view_speed != 'stop':
            show_text(str(view_speed)+'秒/帧',(0,0,255),(811,341),20)
            show_text(str(round(1/view_speed,2))+'帧/秒(FPS)',(0,0,255),(811,361),20)
        else:
            show_text('手动调帧',(0,0,255),(811,341),20)
            show_text('0帧/秒(FPS)',(0,0,255),(811,361),20)
        show_text('R返回主页',(0,0,0),(811,381),30)
        pygame.display.update()