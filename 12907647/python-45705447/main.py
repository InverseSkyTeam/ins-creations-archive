    ...
    def auto(self,player):
        for i in range(len(self.rect_list)):
            if i <= self.count:
                ...
                self.rect_list[i][0].x = (self.rect_list[i][0].x - self.center[0]) * self.rect_list[i][1] + self.center[0]
                self.rect_list[i][0].y = (self.rect_list[i][0].y - self.center[1]) * self.rect_list[i][1] + self.center[1]
