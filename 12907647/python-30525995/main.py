...
def txt_w(name):
    ...
    try:
        ...
        if name == 'abc.txt':
            ...
            text_list = '逆天工作室©2015-2022 小轩电脑©2021,2022 -0.3 Edition -2MB'
        else:
            text_list = ''
...
if part == 'main':
    txt_file1 = File('abc','.txt',(0,71))
    txt_file2 = File('abc2','.txt',(300,71))
    txt_file3 = File('a text file','.txt',(600,71))
    computer_txt_file = File('my computer','.txt',(900,71))
...
while True:
    while part == 'install':
        ...
        show_text('安装完成后，您将得到小轩电脑0.3Edition',pos=(11,41))
        show_text('————最新小轩系统！！！',pos=(11,71))
        show_text('将会在(C:)盘的学而思软件进行安装',pos=(11,101))
        show_text('在此过程中，请不要关闭程序或者关闭您的电脑',pos=(11,131))
        show_text('确保无误就按下空格键开始安装吧！',pos=(11,161))
    ...
    while part == 'install_ok':
        ...
        show_text('版本：小轩电脑0.3Edition',pos=(11,41))
        pygame.display.update()
        try:root.update()
        except:sys.exit()
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_DELETE:
                    ...
                    part = '删除系统'
        screen.fill((65,255,255))
        show_text('小轩电脑0.3 | '+str(round(file_size,2))+'MB/2MB',pos=(11,11))
    ...
    while part == 'BLUESCREEN':
        ...
        show_text('错误问题：file_size > 2MB',color=(255,255,255),pos=(11,41))
    ...
    while part == '删除系统':
        ...
        show_text('小轩电脑0.3Edition:请不我删除我好吗？(O_O)呜呜呜(T_T)',color=(255,255,255),pos=(11,41))
    ...
    while part == '回退':
        ...
        show_text('即将回退到小轩电脑0.2Edition',color=(255,255,255),pos=(11,71))
        show_text('使用起来将会更不方便，更慢，更卡，更垃圾',color=(255,255,255),pos=(11,101))
