...
for i in range(5):
    ...
    while not empty_row(position_x-3,position_x+3,position_y-1):
        position_x = random.randint(0,width-1)
        position_y = fake_height
...
for i in range(3):
    position_x = random.randint(0,width-1)
    position_y = fake_height
    while not empty_row(position_x-4,position_x+4,position_y-1):
        position_x = random.randint(0,width-1)
        position_y = fake_height
    make_hill(position_x,position_y)

for i in range(3):
    position_x = random.randint(0,width-1)
    position_y = fake_height
    while not empty_row(position_x-2,position_x+2,position_y-1):
        position_x = random.randint(0,width-1)
        position_y = fake_height
    make_puddle(position_x,position_y)
