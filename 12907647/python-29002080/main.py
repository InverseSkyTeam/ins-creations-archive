...
pygame.display.set_caption("小轩-创造星球along版本")
...
while True:
            ...
            if page == 1:
                ...
                if period == '石炭纪':
                    ...
                    if planet.YEARS == -300000000:
                        period = '二叠纪'
                if period == '二叠纪':
                    screen.blit(Earth_land_picture_list[2],planet.rect.topleft)
                    planet.YEARS += 20000
                ...
                if period == '三叠纪':
                    ...
                    if planet.YEARS == -200000000:
                        period = '侏罗纪'
                if period == '侏罗纪':
                    screen.blit(Earth_land_picture_list[3],planet.rect.topleft)
                    planet.YEARS += 20000
    ...
    while part == '生物页面':
        ...
        show_text(text='|点击窗口右上角的[X]',pos=(1089,41))
        show_text(text='或右下角的返回键返回',pos=(1089,71))
        pygame.display.update()