...
class App:
    ...
    def version_other(self):
        ...
        self.label.config(font=("",20,"bold"),fg='white',bg='red',wraplength=self.root.winfo_screenwidth(),justify="left")
    ...
    def version_10(self):
        ...
        self.small_words_label.config(font=("微软雅黑",13,),fg='white',bg='red',justify="left")
        ...
        self.qr_img_label = Label(self.root, image=paned.image,background='red')
        self.label1.config(font=("微软雅黑",110,),fg='white',bg='red',justify="left")
        self.big_words_label.config(font=("微软雅黑",20,),fg='white',bg='red',justify="left")
