...
V0.7 build 581 修复嵌套if的indentkeyword没删bug，增加break和continue枢纽
V0.7 build 600 添加while for关联，在quickrun2练习break conti
V0.7 build 610 while的运行支持
V0.7 build 666 修复break无效问题，替换成quickrun2，基本废弃quickruncode一代；解决一个while-if嵌套问题
V0.7 build 700 修复break后面的代码执行以后才能终止的bug
V0.7 build 715 添加read关键字与假time库
'''