...
class XesIde:
    ...
    def __init__(self):
        ...
        title_name3 = tk.Label(self.title_bar,text='Version 1.0正式版',font=('楷体',11,'bold'),bg=self.back_ground,fg='#ff5166')
        ...
        self.program_title = tk.Entry(self.window,highlightcolor='lightgreen',highlightbackground=self.back_ground,highlightthickness=2,textvariable=tk.StringVar(value='请输入作品名称'),width=50)
