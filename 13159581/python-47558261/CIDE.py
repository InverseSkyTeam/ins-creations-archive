...
class CIDE:
    def __init__(self):
        self.tk = Tk()
        self.tk.geometry("500x696+600+10")
        ...
        self.title_iconic = Button(self.title_frame, bg="grey", text="—", bd=0, font='bold', fg='white',
                              activebackground='lightskyblue', activeforeground='white', highlightthickness=0,
                              cursor='hand2', command=self.iconic_window)
        self.title_iconic.grid(row=0)
        self.title_close = Button(self.title_frame,bg="grey",text="×",bd=0,font='blod',activebackground='#ff1e5e',activeforeground='white',padx=5,fg="white",pady=3,command=self.callback,cursor='hand2',highlightthickness=0)
        ...
        Label(self.tk,text="下方终端",bg="grey",fg="white",width=500).pack()
        self.outtext = Text(self.tk,height=200,font=(False,14))
        self.outtext.pack()
    ...
    def move_window(self,event):
        self.tk.geometry("+{0}+{1}".format(event.x_root, event.y_root))
