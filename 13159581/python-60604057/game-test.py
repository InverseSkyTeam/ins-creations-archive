...
while True:
    ...
    if player2_y <= 65:
        screen.blit(pygame.font.SysFont('kaiti', 50).render("玩家1获胜！", True, (0, 0, 0)), (100, 300))
        wined = True
        ws.close()
    if player1_y >= 535:
        screen.blit(pygame.font.SysFont('kaiti', 50).render("玩家2获胜！", True, (0, 0, 0)), (100, 300))
        wined = True
        ws.close()

    if not started:
        screen.blit(pygame.font.SysFont('kaiti', 30).render("等待下一个人的到来...", True, (0, 0, 0)), (50, 300))
