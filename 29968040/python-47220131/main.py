...
class Window:#一个窗口类
    ...
    def draw(self, surface):
        ...
        show_text("逆天团队-横涂纵刷",(0,0,0),(self.window_rect.x+10,self.window_rect.y+10))
    ...
    def handle_event(self, event):
        ...
        if event.type == pygame.MOUSEMOTION:
            if self.mode=='dragging':
                ...
                mouse_pos = pygame.mouse.get_pos()
                self.window_rect.width = max(301,mouse_pos[0]-self.window_rect.x - self.offset_x + 20)
                self.window_rect.height = max(201, mouse_pos[1] - self.window_rect.y - self.offset_x + 20)
