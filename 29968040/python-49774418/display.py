...
# Font
baseFont = pygame.font.SysFont('SimHei', 24)
# Used Colors
grey = (100, 100, 100)
green = (125, 240, 125)
white = (250, 250, 250)
...
# Input Boxes
sizeBox      = TextBox('数组大小', grey, (30, 440, 50, 50), '100')
delayBox     = SlideBox('延迟', grey, (105, 440, 112, 50))
algorithmBox = DropdownBox('排序算法', (242, 440, 140, 50), baseFont)
