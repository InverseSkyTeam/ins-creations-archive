...
class WorldModel:
    def __init__(self, texture_manager):
        self.vertices = None
        self.uv_vertices = np.array([[0, 0], [0, 1], [1, 1], [1, 0]], dtype=np.float64)  # uv_vertices
        self.uv_indices = np.array([[0, 1, 2], [0, 2, 3]], dtype=np.uint32)
        self.uv_index = None
        self.indices = None
        self.lights = self.lights_1_5 = self.lights_1_25 = None
        self.skylights = None
        self.shading = None
        self.sort_indices = None
        self.sort_indices_no_early_z = None
        ...
        self.have_alpha = texture_manager.have_alpha
