...
class Chunk:
    ...
    def draw(self, color_buffer, zbuffer, matrix, daylight_multiplier, light_buffer):
        if self.model.indices is None or not len(self.model.indices):
            return
        render_cube(self.model, color_buffer, zbuffer, matrix, daylight_multiplier, light_buffer)
