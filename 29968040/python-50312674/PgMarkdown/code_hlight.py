try:  # pragma: no cover
    from pygments_old import highlight
    from pygments_old.lexers import get_lexer_by_name, guess_lexer
    from pygments_old.formatters import get_formatter_by_name
    from pygments_old.util import ClassNotFound
    pygments = True
